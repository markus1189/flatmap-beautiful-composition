...
\begin{frame}[fragile]
  ...
  \only<1>{\inputminted[highlightlines={13}, fontsize=\footnotesize]{scala}{snippets/wc-monoid-string.scala}}
  \only<2>{\inputminted[fontsize=\footnotesize]{scala}{snippets/wc-monoid-string.scala}}
\end{frame}
